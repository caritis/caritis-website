...
const milestones = [
  { y: "2023 → aujourd'hui", t: "Co-fondateur · Waspy", d: "Pilotage technique & commercial d'un SaaS IoT déployé en collectivité." },
  { y: "2022 → 2025", t: "DSI Adjoint & PMO Compliance · Prodware Group", d: "Conformité RGPD, NIS2, ISO 42001 dans 3 pays — RACI/RBAC, audits internes." },
  { y: "2016 → 2022", t: "Responsable Projets R&D · Prodware Innovation", d: "PMO Cloud/IA/IoT sur Dynamics 365 — budget 1,5 M€, équipes de 20." },
  { y: "2011 → 2022", t: "Consultant SI · IBM (Anelia Sud-Ouest)", d: "Chef de projet DataMart CMA-CGM — BI, MDM, architecture." },
  { y: "2006 → 2011", t: "Architecte SI Décisionnel · SAP BusinessObjects", d: "Support BI France Télécom, Skill Center, veille technologique." },
];
      ...
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7">
          ...
          <p className="mt-5 text-muted-foreground">
            20+ ans entre R&D, intégration ERP, gouvernance SI et entrepreneuriat —
            chez IBM, SAP BusinessObjects, Prodware Group et aujourd'hui Waspy. La conviction
